    ...
    <main className="w-full bg-[#05053b]  ">
      <section className="relative min-h-[90vh]   bg-[#3e3eaf]  ">
        ...
        {/* <Image
          ...
          width={100}
          height={100}
          className="absolute h-fit w-fit p-3 bg-[#030327]  right-0 rounded-full"
        /> */}
        ...
        <div className="flex min-h-[150  px-5 py-15 md:px-10   sm:min-h-163 sm:px-10  md:py-2 lg:min-h-175 lg:px-20 sm:justify-center sm:py-8 lg:text-left  bg-[#10103d] ">
          <div className="max-w-xl p-12 lg:text-left">
            {/* <h1 className="text-4xl font-bold flex text-[#1264e0] → #9333EA sm:text-2xl lg:text-3xl"> */}
            <div className="flex pt-10  gap-3 text-4xl font-extrabold sm:text-5xl ">

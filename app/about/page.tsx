...
const AboutPage = () => {
  return (
    <main className="w-full min-h-full ">
      <section className="flex bg-[#040329de] min-h-screen w-full justify-center items-center gap-5 lg:gap-12 px-5 sm:px-6 md:px-8 lg:px-12 py-10 lg:py-8  sm:flex-col lg:flex lg:flex-row ">
        {/* <div>
          <Image
            src={"/herophoto.jpg"}
